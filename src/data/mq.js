...
export const mqData = [
    { id: 1, chapter: 'Chapter 1.5', quest_name: 'The Dragon\'s Den', name_en: 'Colon Leaf', name_id: 'Daun Colon', jumlah: 'x5' },
    { id: 2, chapter: 'Chapter 1.5', quest_name: 'The Dragon\'s Den', name_en: 'Hard Dragon Skin', name_id: 'Sisik Naga Keras', jumlah: 'x2' },
    { id: 3, chapter: 'Chapter 1.5', quest_name: 'The Dragon\'s Den', name_en: 'Lamb Meat', name_id: 'Daging Domba', jumlah: 'x1' },
    { id: 4, chapter: 'Chapter 1.8', quest_name: 'Purification Incense', name_en: 'Fairy Feather', name_id: 'Sayap Peri', jumlah: 'x3' },
    { id: 5, chapter: 'Chapter 1.8', quest_name: 'Purification Incense', name_en: 'Thick Beak', name_id: 'Paruh Tebal', jumlah: 'x3' },
    { id: 6, chapter: 'Chapter 1.8', quest_name: 'Purification Incense', name_en: 'Vine', name_id: 'Sulur', jumlah: 'x3' },
    { id: 7, chapter: 'Chapter 2.13', quest_name: 'Trials in the Palace', name_en: 'Swordsman Stone Coin', name_id: 'Koin Batu Ksatria', jumlah: 'x20' },
    { id: 8, chapter: 'Chapter 3.18', quest_name: 'The Invincible... Enemy??', name_en: 'Sand Mole Meat', name_id: 'Daging Tikus Pasir', jumlah: 'x1' },
    { id: 9, chapter: 'Chapter 3.18', quest_name: 'The Invincible... Enemy??', name_en: 'Beast Claw', name_id: 'Cakar Binatang Buas', jumlah: 'x5' },
    { id: 10, chapter: 'Chapter 3.18', quest_name: 'The Invincible... Enemy??', name_en: 'Sand Frog Skin', name_id: 'Kulit Kodok Pasir', jumlah: 'x5' },
    { id: 11, chapter: 'Chapter 3.21', quest_name: 'Fate of the Fortress', name_en: 'Jagged Fang', name_id: 'Taring Bergerigi', jumlah: 'x10' },
    { id: 12, chapter: 'Chapter 3.21', quest_name: 'Fate of the Fortress', name_en: 'Saham Crystal', name_id: 'Kristal Saham', jumlah: 'x5' },
    { id: 13, chapter: 'Chapter 3.21', quest_name: 'Fate of the Fortress', name_en: 'Spiritual Gemstone', name_id: 'Permata Jiwa', jumlah: 'x1' },
    { id: 14, chapter: 'Chapter 8.62', quest_name: 'The Ruins of the Gods', name_en: 'Rokoko Grape', name_id: 'Anggur Rokoko', jumlah: 'x5' },
    { id: 15, chapter: 'Chapter 9.73', quest_name: 'Front Line Base Operation', name_en: 'Labilans Wood', name_id: 'Kayu Labilans', jumlah: 'x10' },
    { id: 16, chapter: 'Chapter 11.89', quest_name: 'The Strolling Forest', name_en: 'Broken Horn', name_id: 'Tanduk Patah', jumlah: 'x20' },
    { id: 17, chapter: 'Chapter 12.102', quest_name: 'Ark Repair', name_en: 'Jabali Stone', name_id: 'Batu Jabali', jumlah: 'x5' },
    { id: 18, chapter: 'Chapter 12.102', quest_name: 'Ark Repair', name_en: 'Growing Ore', name_id: 'Biji Berkembang', jumlah: 'x5' },
    { id: 19, chapter: 'Chapter 14.119', quest_name: 'Fierce Battle with Mutant Lixis', name_en: 'Slimy Thick Skin', name_id: 'Kulit Tebal Berlendir', jumlah: 'x20' },
    { id: 20, chapter: 'Chapter 14.119', quest_name: 'Fierce Battle with Mutant Lixis', name_en: 'Tangled Roots', name_id: 'Akar Melilit', jumlah: 'x10' },
    { id: 21, chapter: 'Chapter 14.119', quest_name: 'Fierce Battle with Mutant Lixis', name_en: 'Menabra Wood', name_id: 'Kayu Menabra', jumlah: 'x10' },
    { id: 22, chapter: 'Chapter 15.124', quest_name: 'The Young Man and the Old Tree', name_en: 'Stagnant Fertilizer', name_id: 'Pupuk Keruh', jumlah: 'x10' },
];
